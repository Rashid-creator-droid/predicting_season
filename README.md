...
В проекте реализована система логгирования результатов в папку [logs](logs).
...
### Тестирование других предобученных моделей.
...
Выбираем изображение, которого не было в датасёте.

**Рисунок 6.1** Результат работы приложения (winter)

![alt text](readme_img/image231.png)


**Рисунок 6.2** Результат работы приложения (spring)

![alt text](readme_img/image2145.png)