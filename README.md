...
Веб-приложение для классификации времени года по изображению с использованием глубокого обучения.
...
**Метрики:**
- Accuracy на валидации: **~89%**
- Accuracy на тестовом наборе: **~99%**
...
График распределение изображений
...
Результат обучения с аугментацией данных.
...
### `ml/models/models.py`
Загрузка предобученных моделей (ResNet-18, ShuffleNet и т.д.) с заменой финального слоя.
